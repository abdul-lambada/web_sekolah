...
<head>
	...
	<title><?= $title  ?> - MTs AL-AMIIN</title>
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title text-center">Masukan Akun</h3>
					</div>
						...
						<form role="form">
							<fieldset>
								...
								<div class="col-sm-12 text-center">
									<a class="btn btn-md btn-primary" href="<?= base_url() ?>"><i class="fa fa-backward"> <b>Kembali</b></a></i>
									<button type="submit" class="btn btn-md btn-success"><i class="fa fa-sign-in"> <b>Login</b></button></i>
								</div>
							</fieldset>
						</form>
						<? echo form_close();
